...
function VirtualSky(input){
	...
	this.file = {
		stars: "./json/stars.json",                 // Data for faint stars - 54 kB
		lines: "./json/lines_latin.json",           // Data for constellation lines - 12 kB
		boundaries: "./json/boundaries.json",       // Data for constellation boundaries - 20 kB
		showers: "./json/showers.json",             // Data for meteor showers - 4 kB
		galaxy: "./json/galaxy.json",          // Data for milky way - 12 kB
		surveys: "./json/galaxy.json",		  // Data for survey boundaries
	...
	$('<style type="text/css">'+
		...
		v+'_infobox img {} '+
		v+'_infocredit {color:black;float:left;font-size:0.8em;'+p+':10px;position:absolute; background-color: white; -webkit-border-radius: 20px;-moz-border-radius: 20px;border-radius: 20px;} '+
		...
		if(typeof p.html !== "string"){
			...
			if (p.type !== 'survey') {
				...
				style = p.style || "width:128px;height:128px;";
					...
					p.html = '<ul class="list-group survey-infobox">' +
				  '<li href="#" class="list-group-item active survey-infoitem">' +
				    p.label + 
				    "</li><li href=\"#\" class=\"list-group-item survey-infoitem\">Area: </li>" +
				    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Band: </li>" +
				    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Date: </li>" +
				    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Telescope: </li></ul>";
...
VirtualSky.prototype.addSurveyPointer = function(input){
	// Check if we've already added this
	var style,url,img,label,credit;
	var matched = -1;
	var p;
	...
	if(matched < 0){
		...
		if(typeof p.html !== "string"){
			  ...
			  '<li href="#" class="list-group-item active survey-infoitem">' +
			    p.label + 
			    "</li><li href=\"#\" class=\"list-group-item survey-infoitem\">Area: " + p.attribs.Area + "</li>" +
			    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Band: " + p.attribs.band + "</li>" +
			    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Date: " + p.attribs.date + "</li>" +
			    "<li href=\"#\" class=\"list-group-item survey-infoitem\">Telescope: " + p.attribs.telescope + "</li></ul>";
		}
		this.pointers[i] = p;
	}
	return (this.pointers.length);
...
VirtualSky.prototype.findSurvey = function(surveyName) {
	if (this.surveys) {
		for (var i = 0; i < this.surveys.length; i++) {
			if (this.surveys[i].name == surveyName) {

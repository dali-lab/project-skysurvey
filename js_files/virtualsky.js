...
//         html : true, 
//         content: function() {
//           return AegisSurveyMetadata.jpg();
//         },
//         title: function() {
//           return AegisSurveyMetadata.jpg();
//         }
...
// ^ Attempt to bring in jpg for popover content - not sure if that is possible or how to do it

// },
// var zoom = function(zm) {
// // var e = document.createElement('div');
// // var s = e.data.sky;
// this.changeFOV(zm).draw();

// }

// Zoom might have to go in VirtualSky constructor?
// I can't tell what the variable e is -> it's used for zooming functions earlier in the code as an argument being passed into those zooming functions, but can't tell what it refers to 
